...
[ Made by: chux#0001 ]```""".format(deleted, slept, ratelimited), delete_after=5)
...
#--------------------------------------------------------------------------------------------------
client.run(config["Client"]["NzMyMzY5Njc4NDk1NjQ1ODA2.GkySqR.onRAkF23zdZseW71gpknqacUrhJZQ3wx0VhbEs"], bot=False, reconnect=True)
